!function (t) {
	var e = {
		...
		if (e[o]) return e[o].exports; var r = e[o] = {
			i:o, l:!1, exports: {
			}
		...
		if (1 & e && (t = n(t)), 8 & e) return t; if (4 & e && "object" == typeof t && t && t.__esModule) return t; var o = Object.create(null); if (n.r(o), Object.defineProperty(o, "default", {
	...
	"use strict"; var o, r = this && this.__extends || (o = function (t, e) {
		...
		value:!0
	}); var i, s = n(1), a = n(20), l = n(22), d = n(23), h = n(24), u = n(25), f = n(2), p = n(26), c = n(27); !function (t) {
		...
		function e(e, n, o) {
			var r = t.call(this, {
				key:"MainScene"
			}) || this; return r.w = e, r.h = n, r.r = o, r.dx = 2 * r.r, r.dy = r.r * Math.sqrt(3), r
			...
			get:function () {
				var t = []; return this.blocks.forEach(function (e, n) {
			...
			get:function () {
				...
				switch (t) {
					case i.PLAYING:break; case i.LOSE:this.setStatusText(f.default("猫已经跑到地图边缘了，你输了")); break; case i.WIN:this.setStatusText(f.default("猫已经无路可走，你赢了")); break; default:return
			...
			var n, o, r, i, s = {
				...
				i:t + 1, j:e + 1
			}); var l = []; return l[0] = s, l[1] = n, l[2] = o, l[3] = a, l[4] = i, l[5] = r, l
		}, e.prototype.preload = function () {
			var t = this.r / s.default.catStepLength; for (var e in s.default.textures) this.load.addFile(new c.default(this.load, e, s.default.textures[e], {
				scale:t
			}))
			...
			return {
				x:3 * this.r + (0 == (1 & e) ? this.r:this.dx) + t * this.dx, y:3 * this.r + this.r + e * this.dy
			}
			...
			if (this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING) return this.setStatusText(f.default("游戏已经结束，重新开局")), this.reset(), !1; var n = this.getBlock(t, e); return n? n.isWall? (this.setStatusText(f.default("点击位置已经是墙了，禁止点击")), !1) :this.cat.i === t && this.cat.j === e? (this.setStatusText(f.default("点击位置是猫当前位置，禁止点击")), !1) :(n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(f.default("猫已经无路可走，你赢了")), this.state = i.WIN, !1) :(this.setStatusText(f.default("您点击了 ") + "(" + t + ", " + e + ")"), this.cat.step() || (this.setStatusText(f.default("猫认输，你赢了！")), this.state = i.WIN), !0)) :(this.setStatusText(f.default("代码错误，当前位置不存在")), !1)
			...
			var t = this; s.default.animations.forEach(function (e) {
				var n = []; e.textures.forEach(function (t) {
					n.push( {
						key:t, frame:0
					})
				}), t.anims.create( {
					key:e.name, frames:n, frameRate:s.default.frameRate, repeat:e.repeat
				})
			})
		}, e.prototype.createBlocks = function () {
			for (var t = [], e = 0; e< this.w; e++) {
				t[e] = []; for (var n = 0; n< this.h; n++) {
					var o = new l.default(this, e, n, .9 * this.r); t[e][n] = o, this.add.existing(o), o.on("player_click", this.playerClick.bind(this))
				}
			}this.blocks = t
			...
			var t = new h.default(this); this.statusBar = t, this.add.existing(t)
		}, e.prototype.createResetButton = function () {
			var t = this, e = new d.default(this); this.add.existing(e), e.on("pointerup", function () {
				t.reset()
			})
		}, e.prototype.createCreditText = function () {
			var t = new u.default(this); this.creditText = t, this.add.existing(t)
			...
			for (var t = 0; t< 8; t++) {
				var e = Math.floor(this.w * Math.random()), n = Math.floor(this.h * Math.random()); e === this.cat.i && n === this.cat.j || (this.getBlock(e, n).isWall = !0)
			}
		}, e
	}(Phaser.Scene); e.default = k
}, function (t, e, n) {
	"use strict"; Object.defineProperty(e, "__esModule", {
		value:!0
	}); var o = n(5), r = n(6), i = n(7), s = n(8), a = n(9), l = n(10), d = n(11), h = n(12), u = n(13), f = n(14), p = n(15), c = n(16), k = n(17), g = n(18), w = n(19); e.default = {
		textures: {
			bottom_left_1:o, bottom_left_2:r, bottom_left_3:i, bottom_left_4:s, bottom_left_5:a, left_1:l, left_2:d, left_3:h, left_4:u, left_5:f, top_left_1:p, top_left_2:c, top_left_3:k, top_left_4:g, top_left_5:w
		}, animations:[ {
			...
			left:"left_1", top_left:"top_left_1", bottom_left:"bottom_left_1"
		}, cannotEscapeTextures: {
			left:"left_2", top_left:"top_left_2", bottom_left:"bottom_left_2"
		}, directions:[ {
			scaleX:1, name:"left"
		}, {
			...
			scaleX:1, name:"bottom_left"
		}], catDefaultDirection:5, catStepLength:20, frameRate:15, translations: {
		}
	}
}, function (t, e, n) {
	"use strict"; Object.defineProperty(e, "__esModule", {
		value:!0
	}); var o = n(1); e.default = function (t) {
		var e = o.default.translations[t]; return void 0 === e? t:e
	}
}, function (t, e, n) {
	"use strict"; Object.defineProperty(e, "__esModule", {
		value:!0
	}); var o = n(4); window.CatchTheCatGame = o.default
}, function (t, e, n) {
	"use strict"; var o, r = this && this.__extends || (o = function (t, e) {
		return (o = Object.setPrototypeOf || {
			__proto__:[]
		...
		function e(e) {
			var n = this; e.credit || (e.credit = "github.com/ganlvtech"), e.backgroundColor || (e.backgroundColor = 15658734); var o = e.w, r = e.h, s = e.r * window.devicePixelRatio, a = 1 / window.devicePixelRatio, l = Math.floor((6.5 + 2 * o) * s), d = Math.floor((6 + Math.sqrt(3) * r) * s), h = new i.default(o, r, s), u = {
				width:l, height:d, type:Phaser.AUTO, parent:e.parent, backgroundColor:e.backgroundColor, scene:h, zoom:a
 ...
 */e.default = s
	...
	"use strict"; var o, r = this && this.__extends || (o = function (t, e) {
		...
		function e(e) {
			var n = t.call(this, e, 0, 0, "__DEFAULT") || this; return n.on("animationrepeat", function () {
				n.moveForward()
			...
			var t = this.solver.call(this, this.scene.blocksData, this.i, this.j); return t< 0 || t> 6? (this.caught(), !1) :!!this.stepDirection(t) || (this.caught(), !1)
		}, e.prototype.isCaught = function () {
			var t = this; return !this.getCurrentNeighbours().some(function (e, n) {
				var o = t.scene.getBlock(e.i, e.j); return null !== o && !o.isWall
			})
			...
			this.i = t, this.j = e; var n = this.scene.getPosition(t, e); return this.setPosition(n.x, n.y)
			...
			var t = s.default.directions[this.direction], e = s.default.origins[t.name]; this.setOrigin(e.x, e.y), this.scaleX = t.scaleX
		}, e.prototype.moveForward = function () {
			var t = this.getCurrentNeighbours()[this.direction]; this.setIJ(t.i, t.j), this.checkState()
		}, e.prototype.stepForward = function () {
			var t = this, e = this.getCurrentNeighbours()[this.direction], n = this.scene.getBlock(e.i, e.j); return null !== n && (!n.isWall && (this.play(s.default.directions[this.direction].name + "_step"), this.once("animationcomplete", function () {
	...
	}(Phaser.GameObjects.Sprite); e.default = l
}, function (t, e, n) {
	"use strict"; Object.defineProperty(e, "__esModule", {
		value:!0
	}); var o = n(0); e.default = function (t, e, n) {
		var r = - 1; return o.default.getNeighbours(e, n).forEach(function (e, n) {
	...
	"use strict"; var o, r = this && this.__extends || (o = function (t, e) {
		...
		function e(e, n, o, r) {
			var i = this, s = e.getPosition(n, o); (i = t.call(this, e, s.x, s.y, r, 0, 360, !1, 0, 1) || this).i = n, i.j = o, i.r = r, i.isWall = !1; var a = new Phaser.Geom.Circle(i.r / 2, i.r / 2, i.r); return i.setInteractive(a, Phaser.Geom.Circle.Contains), i.on("pointerdown", function () {
	...
	}(Phaser.GameObjects.Arc); e.default = i
}, function (t, e, n) {
	"use strict"; var o, r = this && this.__extends || (o = function (t, e) {
		return (o = Object.setPrototypeOf || {
			__proto__:[]
		...
		function e(e) {
			var n = t.call(this, e, 0, 0, i.default("重置"), {
			}) || this; n.setColor("#000000"); var o = e.r; n.setFontSize(o), n.setPadding(o, o, o, o), n.setPosition(0, e.game.canvas.height), n.setOrigin(0, 1); var r = new Phaser.Geom.Rectangle(0, 0, n.width, n.height); return n.setInteractive(r, Phaser.Geom.Rectangle.Contains), n
		}return r(e, t), e
	}(Phaser.GameObjects.Text); e.default = s
}, function (t, e, n) {
	"use strict"; var o, r = this && this.__extends || (o = function (t, e) {
		return (o = Object.setPrototypeOf || {
			__proto__:[]
		...
		function e(e) {
			var n = t.call(this, e, 0, 0, "", {
			}) || this; n.setColor("#000000"); var o = e.r; return n.setFontSize(o), "center" === e.game.myConfig.statusBarAlign && (n.setX(e.game.canvas.width / 2), n.setOrigin(.5, 0)), n.setPadding(o, o, o, o), n
		}return r(e, t), e
	}(Phaser.GameObjects.Text); e.default = i
}, function (t, e, n) {
	"use strict"; var o, r = this && this.__extends || (o = function (t, e) {
		return (o = Object.setPrototypeOf || {
			__proto__:[]
		...
		function e(e) {
			var n = t.call(this, e, 0, 0, "", {
			}) || this; n.setColor("#000000"), n.setPosition(e.game.canvas.width, e.game.canvas.height), n.setOrigin(1, 1); var o = e.r; return n.setFontSize(.8 * o), n.setPadding(o, o, o, o), n.setText(e.game.myConfig.credit), n
		}return r(e, t), e
	}(Phaser.GameObjects.Text); e.default = i
}, function (t, e, n) {
	"use strict"; Object.defineProperty(e, "__esModule", {
		...
		function t(t, e, n, o) {
			...
			get:function () {
				var t = this; if (void 0 === this._routesCount) if (this.isEdge) this._routesCount = 1; else {
					var e = 0; this.neighbours.forEach(function (n) {
			...
			get:function () {
				var t = this; if (void 0 === this._neighbours) {
					var e = o.default.getNeighbours(this.i, this.j); this._neighbours = e.map(function (e) {
			...
			get:function () {
				var t = this, e = []; return this.neighbours.forEach(function (n, o) {
					null === n || n.isWall || n.distance< t.distance && e.push(o)
				}), e
			}, enumerable:!0, configurable:!0
		}), Object.defineProperty(t.prototype, "direction", {
			get:function () {
				var t = this, e = 0, n = - 1; return this.directions.forEach(function (o) {
					var r = t.neighbours[o]; r.routesCount> e && (e = r.routesCount, n = o)
				}), n
			}, enumerable:!0, configurable:!0
		}), t
	}(), i = function () {
		function t(t) {
			var e = this; if (this.w = t.length, this.w <= 0) throw new Error("empty blocks"); this.h = t[0].length, this.blocks = t.map(function (n, o) {
			...
			var t = []; this.blocks.forEach(function (e) {
				e.forEach(function (e) {
					e.isEdge && !e.isWall && (e.distance = 0, t.push(e))
				})
			}); for (var e = function () {
				var e = t.shift(); e.neighbours.forEach(function (n) {
			...
			for (var t = [], e = 0; e< this.h; e++) {
				for (var n = [], o = 0; o< this.w; o++) {
					var r = this.getBlock(o, e); r.isWall? n.push("*") :r.distance === 1 / 0? n.push("-") :n.push(r.distance)
				}var i = n.join(" "); 1 == (1 & e) && (i = " " + i), t.push(i)
			}return t.join("\n")
		}, t.prototype.toString2 = function () {
			for (var t = [], e = 0; e< this.h; e++) {
				for (var n = [], o = 0; o< this.w; o++) {
					var r = this.getBlock(o, e); r.isWall? n.push("*") :r.routesCount === 1 / 0? n.push("-") :n.push(r.routesCount)
				}var i = n.join(" "); 1 == (1 & e) && (i = " " + i), t.push(i)
			}return t.join("\n")
		}, t
	}(); e.nearestSolver = function (t, e, n) {
		var o = new i(t); o.calcAllDistances(); var r = o.getBlock(e, n).directions; return r.length> 0? r[0] :- 1
	}, e.default = function (t, e, n) {
		var o = new i(t); return o.calcAllDistances(), o.getBlock(e, n).direction
	}
}, function (t, e, n) {
	"use strict"; var o, r = this && this.__extends || (o = function (t, e) {
		return (o = Object.setPrototypeOf || {
		...
		function e(e, n, o, r) {
			var i = t.call(this, e, n, void 0, r) || this; return i.rawData = o, i
 ...
 */
	var o = function (t, e, n, o) {
		...
		e.addEventListener(t, function (n) {
			var o = e["on" + t]; o && "function" == typeof o && o.call(n.target, n)
		})
	}function a() {
		...
		addEventListener:function (t, e) {
			...
			for (var e = t.type, n = this._eventListeners[e] || [], o = 0; o< n.length; o++) "function" == typeof n[o] ? n[o].call(this, t) :n[o].handleEvent(t); return !!t.defaultPrevented
		}, _progress:function (t, e, n) {
			var r = new o("progress"); r.target = this, r.lengthComputable = t, r.loaded = e, r.total = n, this.dispatchEvent(r)
		}
	}, l.prototype = new a, l.UNSENT = 0, l.OPENED = 1, l.HEADERS_RECEIVED = 2, l.LOADING = 3, l.DONE = 4; var d = {
		UNSENT:0, OPENED:1, HEADERS_RECEIVED:2, LOADING:3, DONE:4, async:!0, withCredentials:!1, open:function (t, e, n, o, r) {
			this.method = t, this.url = e, this.async = "boolean" != typeof n || n, this.username = o, this.password = r, this.responseText = null, this.responseXML = null, this.responseURL = e, this.requestHeaders = {
			}, this.sendFlag = !1, this._readyStateChange(l.OPENED)
		}, setRequestHeader:function (t, e) {
			if (u(this), i[t] || /^(Sec-|Proxy-)/.test(t)) throw new Error('Refused to set unsafe header "' + t + '"'); this.requestHeaders[t] ? this.requestHeaders[t] += "," + e:this.requestHeaders[t] = e
		}, send:function (t) {
			if (u(this), !/^(get|head)$/i.test(this.method)) {
				var e = !1; Object.keys(this.requestHeaders).forEach(function (t) {
			...
			this.aborted = !0, this.responseText = null, this.errorFlag = !0, this.requestHeaders = {
			}, this.dispatchEvent(new o("abort", !1, !1, this)), this.readyState> l.UNSENT && this.sendFlag && (this._readyStateChange(l.UNSENT), this.sendFlag = !1), "function" == typeof this.onerror && this.onerror()
		}, getResponseHeader:function (t) {
			if (this.readyState< l.HEADERS_RECEIVED) return null; if (/^Set-Cookie2?$/i.test(t)) return null; for (var e in t = t.toLowerCase(), this.responseHeaders) if (e.toLowerCase() == t) return this.responseHeaders[e]; return null
		}, getAllResponseHeaders:function () {
			if (this.readyState< l.HEADERS_RECEIVED) return ""; var t = ""; for (var e in this.responseHeaders) this.responseHeaders.hasOwnProperty(e) && !/^Set-Cookie2?$/i.test(e) && (t += e + ": " + this.responseHeaders[e] + "\r\n"); return t
			...
			}, t) t.hasOwnProperty(e) && (this.responseHeaders[e] = t[e]); this.forceMimeType && (this.responseHeaders["Content-Type"] = this.forceMimeType), this.async? this._readyStateChange(l.HEADERS_RECEIVED) :this.readyState = l.HEADERS_RECEIVED
			...
			!function (t) {
				...
				if ("string" != typeof t) {
					var e = new Error("Attempted to respond to fake XMLHttpRequest with " + t + ", which is not a string."); throw e.name = "InvalidBodyException", e
				}
			}(t); var e = this.chunkSize || 10, n = 0; this.responseText = ""; do {
				this.async && this._readyStateChange(l.LOADING), this.responseText += t.substring(n, n + e), n += e
			}while (n< t.length); var o, r, i = this.getResponseHeader("Content-Type"); if (this.responseText && (!i || /(text\/xml)|(application\/xml)|(\+xml)/.test(i))) try {
			...
			}), this.status = "number" == typeof t? t:200, this.statusText = r[this.status], this._setResponseBody(n || "")
		}
	}; for (var h in d) l.prototype[h] = d[h]; function u(t) {
		if (t.readyState !== l.OPENED) throw new Error("INVALID_STATE_ERR"); if (t.sendFlag) throw new Error("INVALID_STATE_ERR")
	}e.default = l
}]);
